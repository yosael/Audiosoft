		...
		try{
			...
			{	
					...
					{*/
						...
						// Al setear la variable del area de negocio como se aprecia abajo da error (desde que se agregÛ filtro de busqueda por nombre de cliente)
						//.setParameter(2, (loginUser.getUser().getAreaUsuario() != null)?loginUser.getUser().getAreaUsuario().getId():0 )  
						.getResultList();
					/*}
					else
			...
			/*
				...
				*/
				...
				if (reparacionClienteHome.tieneGarantiaVigente(
					...
					ventaProdServHome.getInstance().setDetalle("Cobro con descuento del 100% por cobertura de garant√≠a");
